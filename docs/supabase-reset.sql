-- docs/supabase-reset.sql (opcional, zera tudo e recria)

-- CUIDADO: dropa objetos (idempotente)
...
drop table if exists public.signup_guards cascade;
drop table if exists public.signup_attempts cascade;
drop table if exists public.profiles cascade;

-- Recria exatamente como em schema.sql
