...
// Este é um componente placeholder. A lógica de abrir/fechar o menu será adicionada depois.
export default function UserMenu() {
  ...
  return (
    <div className="relative">
      {/* O avatar do usuário virá aqui */}
      <div className="w-10 h-10 bg-purple-500 rounded-full cursor-pointer"></div>

      {/* Menu dropdown (inicialmente visível para estilização) */}
